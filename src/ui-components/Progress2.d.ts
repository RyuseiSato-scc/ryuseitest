...
export declare type Progress2OverridesProps = {
    Progress2?: PrimitiveOverrideProps<ViewProps>;
...
export declare type Progress2Props = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: Progress2OverridesProps | undefined | null;
}>;
export default function Progress2(props: Progress2Props): React.ReactElement;
