...
export declare type ProgressOverridesProps = {
    ...
    "\u5C65\u6B74\u66F8"?: PrimitiveOverrideProps<TextProps>;
...
export declare type ProgressProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: ProgressOverridesProps | undefined | null;
}>;
