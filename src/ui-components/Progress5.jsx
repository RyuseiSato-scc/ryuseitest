...
export default function Progress5(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "Progress5")}
      {...rest}
    >
      <View
        width="1463px"
        ...
        {...getOverrideProps(overrides, "Rectangle 246")}
      ></View>
      <View
        width="105px"
        height="61px"
      ...
      <View
        ...
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(237,237,237,1)"
        {...getOverrideProps(overrides, "Rectangle 271")}
      ></View>
      <View
        width="116px"
        height="61px"
      ...
      <Text
        ...
        whiteSpace="pre-wrap"
        children="座談会"
        {...getOverrideProps(overrides, "\u5EA7\u8AC7\u4F1A")}
      ></Text>
      <Text
        fontFamily="Inter"
        fontSize="20px"
        ...
        whiteSpace="pre-wrap"
        children="役員面接"
        {...getOverrideProps(overrides, "\u5F79\u54E1\u9762\u63A5")}
      ></Text>
      <Text
        fontFamily="Inter"
        fontSize="20px"
      ...
      <View
        ...
        left="-376px"
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(140,200,255,1)"
        {...getOverrideProps(overrides, "Rectangle 182")}
      ></View>
      <View
        width="6px"
        height="32px"
        ...
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(140,200,255,1)"
        {...getOverrideProps(overrides, "Rectangle 208")}
      ></View>
      <View
        width="6px"
        height="32px"
        ...
        padding="0px 0px 0px 0px"
        backgroundColor="rgba(140,200,255,1)"
        {...getOverrideProps(overrides, "Rectangle 272")}
      ></View>
      <View
        width="6px"
        height="32px"
      ...
      <Icon
        width="24px"
        height="32px"
        viewBox={{ minX: 0, minY: 0, width: 32, height: 24 }}
        paths={[
          {
            d: "M12 0L22.3923 24L1.6077 24L12 0Z",
            fill: "rgba(159,236,255,1)",
            fillRule: "nonzero",
          },
        ]}
        display="block"
        ...
        {...getOverrideProps(overrides, "Polygon 7")}
      ></Icon>
      <Icon
        width="24px"
        height="32px"
        ...
        transformOrigin="top left"
        transform="rotate(90deg)"
        {...getOverrideProps(overrides, "Polygon 8")}
      ></Icon>
      <Icon
        width="24px"
        height="32px"
        ...
        transformOrigin="top left"
        transform="rotate(90deg)"
        {...getOverrideProps(overrides, "Polygon 9")}
      ></Icon>
      <Icon
        width="24px"
        height="32px"
        ...
        transformOrigin="top left"
        transform="rotate(90deg)"
        {...getOverrideProps(overrides, "Polygon 10")}
      ></Icon>
    </View>
  );
}
