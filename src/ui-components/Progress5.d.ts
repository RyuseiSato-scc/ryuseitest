...
export declare type Progress5OverridesProps = {
    Progress5?: PrimitiveOverrideProps<ViewProps>;
    ...
    "Polygon 10"?: PrimitiveOverrideProps<IconProps>;
} & EscapeHatchProps;
export declare type Progress5Props = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: Progress5OverridesProps | undefined | null;
}>;
export default function Progress5(props: Progress5Props): React.ReactElement;
