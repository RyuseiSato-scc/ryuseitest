...
export default function Progress4(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "Progress4")}
      {...rest}
    >
      <View
        width="1463px"
      ...
      <Icon
        ...
        {...getOverrideProps(overrides, "Polygon 4")}
      ></Icon>
      <Icon
        width="24px"
        height="32px"
        ...
        transformOrigin="top left"
        transform="rotate(90deg)"
        {...getOverrideProps(overrides, "Polygon 5")}
      ></Icon>
      <Icon
        width="24px"
        height="32px"
        ...
        transformOrigin="top left"
        transform="rotate(90deg)"
        {...getOverrideProps(overrides, "Polygon 6")}
      ></Icon>
    </View>
  );
}
