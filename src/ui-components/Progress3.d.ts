...
export declare type Progress3OverridesProps = {
    Progress3?: PrimitiveOverrideProps<ViewProps>;
...
export declare type Progress3Props = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: Progress3OverridesProps | undefined | null;
}>;
export default function Progress3(props: Progress3Props): React.ReactElement;
